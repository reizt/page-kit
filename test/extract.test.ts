...
describe("HTML extraction", () => {
  it("converts article HTML to Markdown and absolute URLs", () => {
    const result = extractPage(`<!doctype html><title>Test</title><article>
  ...
  it("falls back to body when Readability finds no article", () => {
    const result = extractPage("<html><title>Fallback</title><body><div>Hello</div></body></html>", "https://example.com");
